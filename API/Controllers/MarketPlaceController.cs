...
public class MarketPlaceController: ControllerBase
{
    ...
    public MarketPlaceController(IMarketPlaceService marketPlaceService, ICryptoService cryptoService, IHttpContextAccessor contextAccessor)
    {
    ...
    {
        var actorBalance = await _cryptoService.GetTokenBalanceAsync(_actorId, "toSpend");
        var subtotal = 0;
