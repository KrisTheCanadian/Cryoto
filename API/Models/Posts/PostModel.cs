...
public class PostModel
{
    ...
    public PostModel(string author, string message, string[] recipients, string[] tags, DateTimeOffset createdDate, string postType = "General", bool isTransactable = false, ulong coins = 0)
    {
        Id = Guid.NewGuid();
        Author = author;
        Message = message;
