...
public class PostsControllerTests
{
    ...
    {
        var mockController = new PostsController(_postService)
        {
    ...
    public async void PostsController_GetPostById_ReturnsNotFound()
    {
        ...
        A.CallTo(() => _postService.GetByIdAsync(A<Guid>.Ignored)).Returns(post);
    ...
    public async void PostController_Create_ReturnsOk()
    {
        ...
        var postCreateModel = new PostCreateModel(post.Message, post.Recipients, post.Tags, post.CreatedDate, post.PostType, post.IsTransactable, post.Coins);
    ...
    public async void PostController_Update_ReturnsOk()
    {
        ...
        var postCreateModel = new PostUpdateModel(post.Id, "New Message", post.Recipients, post.Tags, post.CreatedDate, post.PostType, post.IsTransactable, 100000);
    ...
    public async void PostController_Update_ReturnsConflict()
    {
        ...
        A.CallTo(() => _postService.UpdateAsync(A<PostModel>.Ignored));
        A.CallTo(() => _postService.GetByIdAsync(A<Guid>.Ignored)).Returns(existingPost);
